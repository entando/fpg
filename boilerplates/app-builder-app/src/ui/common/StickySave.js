...
const messages = defineMessages({
  ...
  saveAndApprove: {
    id: 'APP_NAME.saveAndApprove',
  },
  unpublish: {
    id: 'APP_NAME.unpublish',
  },
  setContentAs: {
    id: 'APP_NAME.setContentAs',
  },
  cancel: {
    id: 'APP_NAME.cancel',
  },
  saveAndContinue: {
    id: 'APP_NAME.saveAndContinue',
  },
});
      ...
      <Col xs={12}>
        <Row className="StickySave__row">
          <Col xs={12} className="StickySave__column">
            <strong>
              <FormattedMessage
                id="APP_NAME.stickySave.lastAutoSave"
        ...
        <Row className="toolbar-pf-actions">
          <Col xs={12} md={6} className="StickySave__column">
            <Col xs={12} className="no-padding">
              <strong>
                <FormattedMessage id="APP_NAME.stickySave.status" defaultMessage="Status" />
              </strong>
